...
function Footer(props){
	...
	return(
		<div className='Footer'>
			...
			{TC?<div className='whitebg'>
				<a href='https://www.termsandconditionsgenerator.com/live.php?token=oCoBuUOAu8Y0NVA8oWMhq1okQyOxdLOL'>Terms and Conditions.</a>
			</div>:''}
			{PP?<div className='whitebg'>

					<h2>Privacy Policy</h2>
					<p>Your privacy is important to us. It is Association Yug&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://www.rentyug.com">https://www.rentyug.com</a>, and other sites we own and operate. </p>
